...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var washing = parseFloat(first_sample2.wfreq)
  ...
  // Del 3 - 4. Create the trace for the gauge chart.
    var gaugeData = [
    ...
    // Del 3 - 5. Create the layout for the gauge chart.
    var gaugeLayout = { width: 600, height: 450, margin: { t: 0, b: 0 } };

    // Del 3 - 6. Use Plotly to plot the gauge data and layout.
